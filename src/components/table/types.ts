import type { CellEditor, CellPermissions, CellValue } from './cell-editor.types'

export type * from './cell-editor.types'
...
export type TableCellTarget = { cellKey: string; row: number; col: number }

export type TableSaveChangeset = {
  values: Array<{ target: TableCellTarget; value: CellValue }>
  backgrounds: Array<{ target: TableCellTarget; background: string | null }>
  notes: Array<{ target: TableCellTarget; note: string | null }>
}
